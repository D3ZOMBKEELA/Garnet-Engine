...
void SystemClass::InitializeWindows(int& screenWidth, int& screenHeight)
{
	...
	m_applicationName = L"Garnet Engine v0.1";
	...
	wc.hbrBackground = (HBRUSH)GetStockObject(BLACK_BRUSH); // STUFF
	...
	if (FULL_SCREEN)
	{
		...
		dmScreenSettings.dmBitsPerPel = 32; // Might need to change to 64
